...
function buildMenuText_(actions, opts) {
  ...
  // การตอบ/มอบหมายทำจาก Telegram (มติผู้ใช้ 9 ก.ย. 2569) — กลุ่ม LINE ถามอย่างเดียว
  // คำสั่งตอบใน LINE ยังทำงานเป็นทางสำรอง แต่ไม่โฆษณาในเมนู
  if (tg) {
    text += '\n✍️ ตอบแพทย์ต้นทาง\n' +
      '  ปัดข้อความแจ้งเคสของบอทไปทางขวา (Reply) แล้วพิมพ์คำตอบเลย\n' +
      '  ตอบ 0142: ข้อความ        ระบุเคสด้วยเลข 4 ตัวท้าย\n' +
      '  #ABCD ข้อความ           ตอบตั๋วติดต่อจากแพทย์ต้นทาง (แอดมิน)\n' +
      '  มอบ 0142: ชื่อ           เปลี่ยน/มอบผู้รับผิดชอบเคส (ชื่อตามชีต residents)\n';
  }
