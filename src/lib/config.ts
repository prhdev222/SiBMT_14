...
export const FORM_URL: Record<ReferralType, string | null> = {
  // กลุ่มที่ 1 ไม่ใช้ Google Form แล้ว ตามมติอาจารย์ 2 ส.ค. 2569
  // แพทย์ต้นทางเลือกวันนัดเองที่ /book/transplant แล้วกรอกข้อมูลสั้น ๆ ตอนจอง
  TRANSPLANT_APPOINTMENT: null,
  REGIMEN_CONSULT:
    FORM_BASE +
