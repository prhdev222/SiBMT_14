...
function checkCodeFiles() {
  const EXPECT = {
    ...
    'Util.gs': [
      ...
      'readConfigValue_', 'parseEmailList_', 'urgentPhoneLine_',
    ],
    'Setup.gs': [
    ...
    'GroupQuery.gs': [
      ...
      'buildMenuText_', 'replyOrReport_', 'groupActionsFor_', 'diagnoseGroupQuery',
...
function seedConfigKeys_(ss) {
  ...
  const defaults = [
    ...
    ['opd_phone', '02-419-7642 ถึง 44 ต่อ 104-105', 'เบอร์ธุรการ OPD 700'],
