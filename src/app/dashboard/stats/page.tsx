    ...
    <div className="flex flex-col flex-1 bg-zinc-50">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-6 space-y-4">
        ...
        <p className="text-xs text-zinc-500">
          เคสที่ครบกำหนดถูกย้ายเข้าคลังถาวรแบบถอดชื่อแล้ว จึงไม่ถูกนับที่นี่ —{" "}
          <span className="font-medium">กลุ่มที่ 2 และ 3</span> เมื่อปิดเคสครบ
          12 เดือน ส่วน <span className="font-medium">กลุ่มที่ 1</span> เมื่อเลย
          วันนัดมาแล้ว 30 วัน โดยคลังเก็บไว้แค่เดือนที่เคสเข้ามากับกลุ่มโรค
          ไม่มีวันนัดและชื่อ fellow
        </p>
      </main>
    </div>
  );
