...
`anonymizeExpired()` จะทิ้งไฟล์แนบลงถังขยะ Drive พร้อมกับตอนถอดชื่อเคส
(ครบ `RETENTION_MONTHS` = 12 เดือนหลังปิดเคส) — ใช้ถังขยะไม่ใช่ลบถาวร
จึงกู้คืนได้ 30 วันหากลบผิด
