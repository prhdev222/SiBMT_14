...
export const metadata: Metadata = {
  title: "เวร Chief Resident — ส่งต่อผู้ป่วยโลหิตวิทยา ศิริราช",
        ...
        {shifts.length === 0 ? (
          <div className="rounded-xl bg-amber-50 border border-amber-200 p-5 text-sm text-amber-900 space-y-2">
            ...
            <p>
              ...
              ถ้ายังว่างหลังดึง ให้ตรวจว่ากรอกเวร Chief ใน HSOS แล้ว
            </p>
    ...
    <table className={`mt-3 w-full text-sm ${muted ? "text-zinc-500" : "text-zinc-800"}`}>
      <thead>
        <tr className="text-left text-xs text-zinc-500">
          ...
          <th className="pb-2 font-medium">Chief resident</th>
        </tr>
      </thead>
      <tbody>
        {shifts.map((s) => (
