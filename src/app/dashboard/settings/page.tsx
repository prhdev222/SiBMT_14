 ...
 *
 * ป้องกันการแก้พลาด: (1) ให้ Protect แถวหัวคอลัมน์ในชีต (ทำครั้งเดียว —
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-6 space-y-5">
        ...
        <section className="rounded-xl bg-amber-50 border border-amber-300 p-5 text-sm text-amber-900 space-y-2">
          ...
          <ul className="ml-4 list-disc space-y-1">
            ...
            <li>
              ป้องกันถาวร: กดปุ่ม <strong>&ldquo;🔒 ล็อกหัวคอลัมน์ทุกแท็บ&rdquo;</strong>{" "}
              ด้านล่าง ครั้งเดียว — จากนั้นแถวหัวจะถูกล็อกไว้ กันการแก้พลาดโดย
              ไม่ตั้งใจ (แถวข้อมูลยังแก้ได้ตามปกติ)
            </li>
            <li>
